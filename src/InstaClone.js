            ...
            <View style={styles.container}>
                ...
                <ScrollView>
                    ...
                    <View style={styles.userBar}>
                        ...
                        <Image
                            style={[styles.icon, { height: 28, width: 28, left: 200 }]}
                            source={config.images.ellipsisIcon} />
                    </View>
                    <TouchableOpacity
                        activeOpacity={0.7}
                        onPress={() => {
                    ...
                    <View style={[styles.userBar]}>
                        <Text style={{ fontSize: 15, marginLeft: 8 }}>1276797 likes</Text>
                    </View>
                    ...
                    <View style={styles.userBar}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Image
                                style={[styles.icon, { height: 28, width: 28, left: 180 }]}
                                source={config.images.ellipsisIcon} />
                        </View>
                    </View>
                    <TouchableOpacity
