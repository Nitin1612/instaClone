export default {
    images :{
        ...
        downIcon : require('../../assets/down.png'),
        plusRoundedIcon : require('../../assets/icons8-add-new-50.png'),
        menuIcon : require('../../assets/icons8-menu-rounded-50.png'),
        addIcon : require('../../assets/icons8-add-30.png'),
        plusIcon : require('../../assets/icons8-plus-math-24.png'),
        gridIcon : require('../../assets/icons8-grid-50.png')
    }
}